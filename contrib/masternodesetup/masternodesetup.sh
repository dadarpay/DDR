...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='ddr.conf'
CONFIGFOLDER='/root/.ddr'
COIN_DAEMON='ddrd'
COIN_CLI='ddr-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Dadar/Dadar/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
