...
#define MyAppName "Dadar"
#define MyAppPublisher "2022 Dadar developers"
#define MyAppURL "https://dadar.xyz/"
#define MyAppExeName "ddr-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/DDR/bootstrap.zip"
...
[Files]
Source: ".\package\ddr-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Dadar\Dadar-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Dadar\Dadar-Qt,strDataDir|{userappdata}\Dadar\}');
  Result := True;
end;
