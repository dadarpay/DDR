...
ddr.conf           | contains configuration settings for ddrd or ddr-qt
ddrd.pid           | stores the process id of ddrd while running
...
debug.log           | contains debug information and general logging generated by ddrd or ddr-qt
