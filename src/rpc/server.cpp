...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DDR features */
        {"ddr", "listmasternodes", &listmasternodes, true },
        {"ddr", "getmasternodecount", &getmasternodecount, true },
        {"ddr", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ddr", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ddr", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ddr", "masternodecurrent", &masternodecurrent, true },
        {"ddr", "startmasternode", &startmasternode, true },
        {"ddr", "createmasternodekey", &createmasternodekey, true },
        {"ddr", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ddr", "listmasternodeconf", &listmasternodeconf, true },
        {"ddr", "getmasternodestatus", &getmasternodestatus, true },
        {"ddr", "getmasternodewinners", &getmasternodewinners, true },
        {"ddr", "getmasternodescores", &getmasternodescores, true },
        {"ddr", "preparebudget", &preparebudget, true },
        {"ddr", "submitbudget", &submitbudget, true },
        {"ddr", "mnbudgetvote", &mnbudgetvote, true },
        {"ddr", "getbudgetvotes", &getbudgetvotes, true },
        {"ddr", "getnextsuperblock", &getnextsuperblock, true },
        {"ddr", "getbudgetprojection", &getbudgetprojection, true },
        {"ddr", "getbudgetinfo", &getbudgetinfo, true },
        {"ddr", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ddr", "mnfinalbudget", &mnfinalbudget, true },
        {"ddr", "checkbudgets", &checkbudgets, true },
        {"ddr", "mnsync", &mnsync, true },
        {"ddr", "spork", &spork, true },
        {"ddr", "getcollateral", &getcollateral, true},
...
{
    return "> ddr-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19870/\n";
}
