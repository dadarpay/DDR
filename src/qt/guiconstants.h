...
/* Dadar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Dadar"
#define QAPP_ORG_DOMAIN "dadar.xyz"
#define QAPP_APP_NAME_DEFAULT "Dadar-Qt"
#define QAPP_APP_NAME_TESTNET "Dadar-Qt-testnet"
