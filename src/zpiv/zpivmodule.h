...
static int const PUBSPEND_DDRNORR = 4;
...
public:
    ...
    bool Verify() const;
    static bool isAllowed(const bool fUseV1Params, const int spendVersion) { return !fUseV1Params || spendVersion >= PUBSPEND_DDRNORR; }
