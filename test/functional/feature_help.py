...
"""Verify that starting ddr with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ddr with -? for help text")
        ...
        self.log.info("Start ddr with -version for version information")
