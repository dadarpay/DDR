Contributing to Dadar Core
============================

The Dadar Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/dadarpay/DDR/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Dadar Core project, and is not to be
confused with overall Dadar Network Protocol consensus changes.

Whether a pull request is merged into Dadar Core rests with the project merge
...
Patches that change Dadar consensus rules are considerably more involved than
...
Where a patchset proposes to change the Dadar consensus, it must have been
...
The project leader is the release manager for each Dadar Core release.
